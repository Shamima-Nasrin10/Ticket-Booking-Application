...
import com.shamnas.ticket_booking.databinding.SeatItemBinding;
    ...
    public void onBindViewHolder(@NonNull SeatAdapter.SeatViewholder holder, int position) {
        ...
        switch (seat.getStatus()) {
            ...
            case SELECTED:
                ...
                holder.binding.seatImageView.setTextColor(ContextCompat.getColor(context, R.color.midnight_blue));
                break;
            case UNAVAILABLE:
